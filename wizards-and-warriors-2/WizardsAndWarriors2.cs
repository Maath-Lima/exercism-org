...
static class GameMaster
{
    ...
    public static string Describe(Character character, Destination destination, TravelMethod? travelMethod = null) => $"{Describe(character)} {Describe(travelMethod.Value)} {Describe(destination)}";
