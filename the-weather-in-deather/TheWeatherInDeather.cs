...
public class WeatherStation
{
    ...
    public Outlook ShortTermOutlook => reading.Equals(new Reading()) ? throw new ArgumentException() : GetShortOutlook();

    private Outlook GetShortOutlook()
    {
    ...
    public Outlook LongTermOutlook
    {
        get
        {
            return reading switch
            {
                ...
                _ when reading.WindDirection == WindDirection.Southerly|| reading.WindDirection == WindDirection.Easterly 
